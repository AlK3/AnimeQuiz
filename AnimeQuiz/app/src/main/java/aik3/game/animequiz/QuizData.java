...
public final class QuizData extends AppCompatActivity {
    ...
    private Title[] titles = {
            ...
            new Title(4, R.drawable.wcaay, "Волчьи дети Амэ и Юки", "android.resource://aik3.game.animequiz/raw/wcaay_e", "android.resource://aik3.game.animequiz/raw/", "Рассказывает о жизни маленькой, но очень необычной семьи, которой предстоит пройти через множество трудностей, чтобы сохранить свой секрет от посторонних."),
            ...
            new Title(9, R.drawable.dn, "Тетрадь смерти", "android.resource://aik3.game.animequiz/raw/dn", "android.resource://aik3.game.animequiz/raw/file_example", " А что случится, если тетрадь бога окажется в руках человека? Ответ очевиден: он возомнит себя богом."),
            ...
            new Title(12, R.drawable.mia, "Созданный в Бездне", "android.resource://aik3.game.animequiz/raw/mia", "android.resource://aik3.game.animequiz/raw/mia_e", "Загадочная территория, которая манит своей секретностью. Там проживают необычные создания, которых невозможно встретить на Земле, и хранятся поразительные сокровища."),
            new Title(13, R.drawable.msr, "Монстр", "android.resource://aik3.game.animequiz/raw/msr", "android.resource://aik3.game.animequiz/raw/msr_e", "Прошло девять лет и убийства в Дюссельдорфе начались вновь. Монстр появился в городе. И в жизни Тэммы, чтобы в один дождливый вечер сказать: «Ты - тот, кто вернул меня к жизни, доктор…»"),
            new Title(14, R.drawable.kon, "К-он!", "android.resource://aik3.game.animequiz/raw/kon", "android.resource://aik3.game.animequiz/raw/kon_e", "Главная героиня, начинающая гитаристка, спасая школьный музыкальный клуб от закрытия, она собирает музыкальный коллектив."),
            ...
            new Title(20, R.drawable.codeg, "Код Гиас", "android.resource://aik3.game.animequiz/raw/codeg", "android.resource://aik3.game.animequiz/raw/cogeg_e", "Главный герой встречает не совсем обычную девушку, которая представляется С.С., она предлагает ему дар - способность подчинять волю других людей."),
