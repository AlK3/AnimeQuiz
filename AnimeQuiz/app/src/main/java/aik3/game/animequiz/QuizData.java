...
public final class QuizData extends AppCompatActivity {
    ...
    private Title[] titles = {
            ...
            new Title(20, R.drawable.codeg, "Код Гиас", "android.resource://aik3.game.animequiz/raw/cg", "Главный герой встречает не совсем обычную девушку, которая представляется С.С., она предлагает ему дар - способность подчинять волю других людей"),
