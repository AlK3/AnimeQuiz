...
public final class QuizData extends AppCompatActivity {
    ...
    private Title[] titles = {
            ...
            new Title(10, R.drawable.hing, "Хеллсинг: Война с нечистью", "android.resource://aik3.game.animequiz/raw/hing", "android.resource://aik3.game.animequiz/raw/file_example", "В мире всегда существовали ужасные существа, и пришло время, когда враги сумели обрести неимоверное могущество. Всё чаще на территории Англии начали появляться кровожадные вампиры."),
            new Title(11, R.drawable.hh, "Хантер х Хантер", "android.resource://aik3.game.animequiz/raw/hh", "android.resource://aik3.game.animequiz/raw/file_example", "Многие авантюристы пускаются во все тяжкие в погоне за мечтой стать прославленным Охотником."),
            new Title(12, R.drawable.mia, "Созданный в Бездне", "android.resource://aik3.game.animequiz/raw/mia", "android.resource://aik3.game.animequiz/raw/file_example", "Загадочная территория, которая манит своей секретностью. Там проживают необычные создания, которых невозможно встретить на Земле, и хранятся поразительные сокровища."),
            new Title(13, R.drawable.msr, "Монстр", "android.resource://aik3.game.animequiz/raw/msr", "android.resource://aik3.game.animequiz/raw/file_example", "Прошло девять лет и убийства в Дюссельдорфе начались вновь. Монстр появился в городе. И в жизни Тэммы, чтобы в один дождливый вечер сказать: «Ты - тот, кто вернул меня к жизни, доктор…»"),
